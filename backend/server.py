...
## OLD EXTRACTION FUNCTIONS REMOVED ##
# The old extract_text_from_image() and extract_text_from_pdf() functions have been removed.
# Sheet music is now processed exclusively via the Gemini Vision API in omr_service.py
# The upload flow now calls process_sheet_music_omr() directly for PDF/image files.
